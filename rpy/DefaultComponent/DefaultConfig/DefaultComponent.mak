...
Client.obj : Client.cpp Client.h    Default.h IPrint.h 
	$(CREATE_OBJ_DIR)
...
Server.obj : Server.cpp Server.h    Default.h IPrint.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Server.obj" "Server.cpp" 



Default.obj : Default.cpp Default.h    Client.h IPrint.h Server.h 
	$(CREATE_OBJ_DIR)
